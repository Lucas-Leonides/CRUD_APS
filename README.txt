...
- `models/Produto.js`: Contém o modelo do produto, com os campos `name`, `description`, `quantity`, `imageUrl`.
- `routes/produtos.js`: Define as rotas para CRUD de produtos, incluindo a funcionalidade de upload de imagens.
...
No terminal, navegue até a pasta do projeto. Execute o seguinte comando para iniciar o servidor:
